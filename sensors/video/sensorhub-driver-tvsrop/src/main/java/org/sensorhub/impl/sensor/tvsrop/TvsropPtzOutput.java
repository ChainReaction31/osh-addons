...
public class TvsropPtzOutput extends AbstractSensorOutput<TvsropDriver> {
    ...
    public TvsropPtzOutput(TvsropDriver driver)
    {
        super(driver);
    }
    ...
    protected void start() throws SensorException
    {
        ...
        try
        {
            ...
            TimerTask timerTask = new TimerTask()
            {
                ...
                public void run()
                {
                    synchronized (TvsropPtzOutput.this)
                    {
    ...
    protected synchronized void sendPtzStatus()
    {
        ...
        eventHandler.publishEvent(new SensorDataEvent(latestRecordTime, TvsropPtzOutput.this, latestRecord));
    }
